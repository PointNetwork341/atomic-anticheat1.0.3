execute @s[scores={stafftag=1,wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_X 40000
execute @s[scores={stafftag=1,wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_Z 40000
...
execute @s[scores={stafftag=1}] ~~~ tellraw @a[scores={stafftag=1,wbmtoggle=1}] {"rawtext":[{"text":"§¶§cAtomic §¶§b→ §6World Border §bhas been set to §240k §bby §d"},{"selector":"@s"}]}
