execute @s[scores={stafftag=1,wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_X 70000
execute @s[scores={stafftag=1,wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_Z 70000
