execute @s[scores={stafftag=1,wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_X 20000
execute @s[scores={stafftag=1,wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_Z 20000
...
execute @s[scores={stafftag=1}] ~~~ tellraw @a[scores={stafftag=1,wbmtoggle=1}] {"rawtext":[{"text":"§¶§cAtomic §¶§b→ §6World Border §bhas been set to §220k §bby §d"},{"selector":"@s"}]}
