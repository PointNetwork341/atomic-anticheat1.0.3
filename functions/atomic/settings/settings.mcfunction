...
# Protection against the command block exploit.
# Enabled by default
function atomic/modules/extra-anticbe
#
# =Extra-Features=
# Features.
# Enabled by default
function atomic/modules/extrafeatures
#
# =Lockdown=
# Locks down the realm.
# Enabled by default
function atomic/modules/lockdown
#
# =AntiFly=
...
#
# =No Illegal Items=
# Clears players of Illegal items.
