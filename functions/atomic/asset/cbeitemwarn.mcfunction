...
#cbewarn alerts
execute @s[scores={warncbe=2}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic → §6Anti CBE §btemp kicked §d"},{"selector":"@s"},{"text":" §¶§bfor attempting CBE Exploit §7[§c2§7/§24§7]"}]}
execute @s[scores={warncbe=3}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic → §6Anti CBE §btemp kicked §d"},{"selector":"@s"},{"text":" §¶§bfor attempting CBE Exploit §7[§c3§7/§24§7]"}]}
execute @s[scores={warncbe=4}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic → §6Anti CBE §btemp kicked §d"},{"selector":"@s"},{"text":" §¶§bfor attempting CBE Exploit §7[§c4§7/§24§7]"}]}
