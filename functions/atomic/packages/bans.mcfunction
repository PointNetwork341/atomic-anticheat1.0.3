...
#Global Bans (NOT USED RIGHT NOW)
...
#Kick Messages (NOT USED RIGHT NOW)
...
#Anti-Creative Stuff
#execute @a[m=c,tag=!stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic → §d"},{"selector":"@s"},{"text":" §¶§cChanged Their Gamemode."}]}
#gamemode s @a[m=c,tag=!stafftag]
