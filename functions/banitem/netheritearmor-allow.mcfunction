...
execute @s[tag=stafftag] ~~~ execute @s[scores={ibmtoggle=1}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic §¶§b→ §6Netherite Armor §bhas been §2ALLOWED §bby §d"},{"selector":"@s"}]}
