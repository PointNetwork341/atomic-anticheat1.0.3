...
execute @s[scores={stafftag=1}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cAtomic §¶§b→ §bdiamond Kit has been applied to §d"},{"selector":"@s"}]}
execute @s[scores={stafftag=1}}] ~~~ playsound note.pling @s ~ ~ ~
execute @s[scores={stafftag=0}] ~~~ playsound note.bass @s ~ ~ ~

replaceitem entity @s[scores={stafftag=1}] slot.armor.head 0 diamond_helmet 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[scores={stafftag=1}] slot.armor.chest 0 diamond_chestplate 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[scores={stafftag=1}] slot.armor.legs 0 diamond_leggings 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[scores={stafftag=1}] slot.armor.feet 0 diamond_boots 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[scores={stafftag=1}] slot.weapon.offhand 0 totem_of_undying 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[scores={stafftag=1}] slot.weapon.mainhand 0 diamond_sword 1 0 {"minecraft:keep_on_death":{}}
